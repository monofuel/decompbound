...
proc main() =
  ...
  for f in 1 .. 20000:
    ...
    if home and pokeyKnockPercent(snes) >= 70 and px >= 0x1C00:
      if py >= 0x0200:
        snes.joy1 = 0x0100
      elif px > 0x1E20:
        snes.joy1 = if (f mod 3)==0: 0x0400'u16 else: 0x0200'u16
      elif abs(px.int - 0x1D0D) > 4:
        snes.joy1 = if px > 0x1D0D: 0x0200'u16 else: 0x0100'u16
      elif py < 0x0170:
        snes.joy1 = 0x0400
      else:
        snes.joy1 = 0x0800
